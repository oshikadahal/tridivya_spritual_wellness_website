        ...
        <form onSubmit={handleSubmit(submit)} className="space-y-5">
            <div className="space-y-1">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        type="email"
                        autoComplete="email"
                        className="h-11 w-full rounded-full bg-white/6 border border-white/8 px-10 text-sm text-white placeholder-white/50 outline-none focus:ring-2 focus:ring-cyan-400"
                        {...register("email")}
            ...
            <div className="flex items-center justify-between text-sm text-white/80">
                <label className="flex items-center gap-2">
                    <input type="checkbox" className="h-4 w-4 rounded-sm bg-white/6 border-white/10" />
