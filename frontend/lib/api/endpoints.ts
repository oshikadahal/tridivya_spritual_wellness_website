...
export const API= {
    ...
    ADMIN: {
        ...
        UPDATE_BOOKING: (id: string) => `/api/admin/bookings/${id}`,
        BOOKING_STATUS: (id: string) => `/api/admin/bookings/${id}/status`,
        BOOKING_BY_ID: (id: string) => `/api/admin/bookings/${id}`,
        DASHBOARD_OVERVIEW: "/api/admin/dashboard/overview",
        REVIEWS: "/api/admin/reviews",
        REVIEW_BY_ID: (type: string, contentId: string, reviewId: string) => `/api/admin/reviews/${type}/${contentId}/${reviewId}`,
